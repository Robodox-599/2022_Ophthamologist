...
void command_VisionTracking::Execute()
{
  ...
  if (m_vision->isVisionOnline() && m_vision->getBlocks(0.65, 1.35, subsystem_Vision::sigs::red).size() > 0)
  {
    PixyBlock desiredBlock = m_vision->getDesiredBlock(m_vision->getBlocks(0.65, 1.35, subsystem_Vision::sigs::red));
