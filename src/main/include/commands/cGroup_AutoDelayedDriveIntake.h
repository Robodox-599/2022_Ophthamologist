...
class cGroup_AutoDelayedDriveIntake
    : public frc2::CommandHelper<frc2::SequentialCommandGroup,
                                 cGroup_AutoDelayedDriveIntake> {
 public:
  cGroup_AutoDelayedDriveIntake(subsystem_Drive* Drive, subsystem_Shooter* Shooter, subsystem_Arm* Arm, double power, int inches, double timeout);
};
