 ...
 */
class command_VisionTest
    : public frc2::CommandHelper<frc2::CommandBase, command_VisionTest> {
 public:
  command_VisionTest(subsystem_Vision *vision, subsystem_Drive *drive);
 ...
 private:
  ...
  static constexpr double pMax = 0.5;
